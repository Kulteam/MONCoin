...
// Copyright (c) 2018-2019, The MONCoin Developers
//
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 2199681;
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "012801ff000100025f388741db18707e22a78799a374693e15587eb51525eeec6f108002efdeccb92101a9ccdc1db7bec27a9e37138331628a9ceb603eb4a7663b46a95a63d7a534a38f";
static_assert(sizeof(GENESIS_COINBASE_TX_HEX)/sizeof(*GENESIS_COINBASE_TX_HEX) != 1, "GENESIS_COINBASE_TX_HEX must not be empty.");

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in TurtleCoind. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1626863765;
...
const char     LATEST_VERSION_URL[]                          = "http://moncoin.io";
const std::string LICENSE_URL                                = "https://github.com/Kulteam/MONCoin/blob/main/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0x31, 0x14, 0xfb, 0x31, 0xf5, 0x37, 0x14, 0xe, 0xef, 0xd7, 0x14, 0xcb, 0x4f, 0xdd, 0x31, 0xe  }
};

const char* const SEED_NODES[] = {
  "sv1.moncoin.io:12897",
  "sv2.moncoin.io:12897", 
  "sv3.moncoin.io:12897", 
  "node-asian.moncoin.io:12897", 
  "node-europe.moncoin.io:12897", 
  "node-africa.moncoin.io:12897" 
};
} // CryptoNote
